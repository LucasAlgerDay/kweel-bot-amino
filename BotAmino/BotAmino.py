...
def print_exception(exc):
    print(repr(exc))
#{'http': 'socks5://butteraminopy:butteraminopy@154.95.36.199:6893','https':'socks5://butteraminopy:butteraminopy@154.95.36.199:6893'}
#19BE44CA3A5499B5D8BE1A0C493250E1BFC1A8D503201EA93168271CA00E4BD4E6272F66E0EC63ECD2
class BotAmino(Command, Client, TimeOut, BannedWords):
    def __init__(self, email: str = None, password: str = None, sid: str = None,proxies: str = {'http': 'socks5://itskwel999:zNFqCpVPeB@185.228.194.156:50101','https': 'socks5://itskwel999:zNFqCpVPeB@185.228.194.156:50101'} , deviceId: str ="19018060F4195790EE4AF93B2E844F46635DFABA92A01E10895543B5068B0DFA4754A4B135E28B02F8", certificatePath: str = None):
        ...
        self.perms_list = ["c1a6bf04-4907-471b-9163-3895c003ff21","ae73a7d5-797d-4e87-8fc0-20b016fa6e38","a009b375-51ce-40c3-baa2-76832fd4c496","be5d26a2-02b1-40d1-a11c-43b0a4ea743d"]
        self.prefix = "!"
        self.activity = False
        self.wait = 0
        self.bio = None
        self.self_callable = True
        self.no_command_message = " type !help to get my commands !! - Kwel hein toh apney ghabrana nahi 🥀"
        self.spam_message = ""
